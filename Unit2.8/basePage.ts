...
export class BasePage {
    ...
    async navigate(url?: string): Promise<void> {
        ...
        else return Promise.reject('You need a url to test the page pleass add one in the page objects or you tests')
    }
    ...
    async getAttribute(elementBy: By, atrribute: string) {
        return (await this.getElement(elementBy)).getAttribute(atrribute)
    }
